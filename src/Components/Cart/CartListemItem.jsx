...
const CartListItem = () => {
    ...
    return (
        <section className="flex flex-col justify-evenly object-contain bg-transparent w-full h-full">
            <div>
            ...
            <div>
                        ...
                        <table className=' table-fixed w-full border border-slate-400 border-separate border-spacing-2'>
                            <tbody>
                                <tr className='uppercase text-lg font-semibold'>
                                    ...
                                    <td></td>
                                    <td>total</td>
                                    <td>$ {getTotalPrice(cart)}</td>
                                    <td className='inline-block'><button className="flex items-center rounded-md border-solid  p-1 font-semibold bg-violet-300 hover:bg-black hover:text-white border-black hover:scale-90 duration-700"
                                        onClick={deleteCart}>
                                        <p className='pr-1'>Eliminar</p><TbShoppingCartOff />
                ...
                <Link to="/checkout">
                    <button className='p-2 rounded-md border-solid  m-8 font-semibold bg-violet-300 hover:bg-black hover:text-white border-black hover:scale-90 duration-700'
                    >Siguiente</button>
                </Link>
            </div>
        </section>
